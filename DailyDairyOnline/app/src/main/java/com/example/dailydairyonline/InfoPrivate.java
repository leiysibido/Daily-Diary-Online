...
public class InfoPrivate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_private);
        ...
        btnBack.setOnClickListener(view ->{
            Intent intent = new Intent(InfoPrivate.this, ProfileActivity.class);
